...
public class XinTuoCpControler {
     ...
     * @return
     */
    @RequestMapping(value = "/xtcpList")
    public String xtcpList(Model model) {
     ...
     * @return
     */
    @RequestMapping(value = "/initXtcp")
    public String initXtcp(Model model ,@RequestParam(value="xtgsId",required=false) Long xtgsId) {  
     ...
     * @return
     */
    @RequestMapping(value = "/updateXtcp")
    public String updateXtcp(ProductXtgs model) {
