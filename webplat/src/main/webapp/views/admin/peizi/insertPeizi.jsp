...
<div class="modal-body">
    <form id="modalForm" action="rest/admin/peizi/peizi/insertData" method="post" class="form-horizontal" role="form" data-submit="#modalSaveBtn">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            ...
            <div class="col-md-6">
                <input type="text" class="form-control  number" name="dataZjsyqx" value="" readonly="readonly">
            </div>            
        </div>
