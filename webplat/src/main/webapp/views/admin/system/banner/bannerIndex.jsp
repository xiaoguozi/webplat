...
<div class="row">
    <div class="col-md-12">
        ...
        <h3 class="page-title" id="index-page-title">信托产品管理</h3>
            ...
            <table id="list-data" class="table table-striped table-bordered table-hover dataTable no-footer">
                <thead>
                    <tr>
                        ...
                        <th field="title">标题<span class="glyphicon"></span></th>
                        <th field="home_url">链接地址<span class="glyphicon"></span></th>
                        <th field="order_index">排序<span class="glyphicon"></span></th>                                                                    
                    </tr>
                </thead>
                <tbody>
                </tbody>
...
$(function(){
    var insertUrl = "rest/admin/system/banner/insert";
    var updateUrl = "rest/admin/system/banner/update";
    var viewUrl = "rest/admin/system/banner/view";
    var deleteDataUrl = "rest/admin/system/banner/deleteData";
    var listDataCountUrl = "rest/admin/system/banner/listDataCount";
    var listDataUrl = "rest/admin/system/banner/listData";
