...
<div class="row">
    <div class="col-md-12">
        ...
        <h3 class="page-title pull-left">banner<small>新增</small></h3>
...
<div class="modal-body">
    <form id="modalForm" action="rest/admin/system/banner/insertData" method="post" class="form-horizontal" role="form" data-submit="#modalSaveBtn">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            ...
            <div class="col-md-6">
                <input type="text" class="form-control required number" name="orderIndex" value="${sysHome.orderIndex}" >
            </div>
