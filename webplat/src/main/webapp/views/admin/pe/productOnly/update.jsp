...
<!-- END PAGE HEADER-->
<div>
	<ul class="nav nav-tabs" role="tablist" id="only_myTab">
...
<div class="tab-content">
  ...
  <div class="row">
	...
	<div class="pull-right">
	    <button type="button" class="btn btn-default only_modalCloseBtn" data-dismiss="modal">关闭</button>
	</div>
        <!-- END PAGE TITLE & BREADCRUMB-->
    </div>
</div>
<div class="modal-body">
    <form id="only_modalForm" action="rest/admin/pe/peProduct/updateData" method="post" class="form-horizontal" role="form" data-submit="#only_modalSaveBtn">
...
$(function(){
    ...
    Btk.form($("#only_modalForm"),"update",function(data){
        if("0"==data.code){
    ...
    $("button.only_modalCloseBtn").unbind('click').click(function(event) {
        only_IndexPage.togglePage('list');
    });
