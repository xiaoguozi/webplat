...
<div class="tab-content">
  ...
  <div class="row">
	...
	<div class="pull-right">
	    <button type="button" class="btn btn-primary only_modalCloseBtn" data-dismiss="modal">关闭</button>
	</div>
        <!-- END PAGE TITLE & BREADCRUMB-->
    </div>
</div>
<div class="modal-body">
    <form id="only_modalForm" action="" method="post" class="form-horizontal" role="form" data-submit="#modalSaveBtn">
