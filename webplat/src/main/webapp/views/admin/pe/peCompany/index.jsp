...
<div class="row">
    <div class="col-md-12">
        ...
        <h3 class="page-title" id="index-page-title">私募公司管理</h3>
            ...
            <table id="list-data" class="table table-striped table-bordered table-hover dataTable no-footer">
                <thead>
                    <tr>
                        ...
                        <th field="area">所在区域 <span class="glyphicon"></span></th>
...
$(function(){
    var insertUrl = "rest/admin/pe/peCompany/insert";
    var updateUrl = "rest/admin/pe/peCompany/update";
    var viewUrl = "rest/admin/pe/peCompany/view";
    var deleteDataUrl = "rest/admin/pe/peCompany/deleteData";
    var listDataCountUrl = "rest/admin/pe/peCompany/listDataCount";
    var listDataUrl = "rest/admin/pe/peCompany/listData";
