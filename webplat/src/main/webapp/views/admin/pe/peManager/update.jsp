...
<div class="row">
    <div class="col-md-12">
        ...
        <h3 class="page-title pull-left">私募经理  <small>修改</small></h3>
    </div>
</div>
<!-- END PAGE HEADER-->
...
<div class="modal-body">
    <form id="modalForm" action="rest/admin/pe/peManager/updateData" method="post" class="form-horizontal" role="form" data-submit="#modalSaveBtn">
       <input type="hidden" name="id" value="${peManager.id}">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            ...
            <div class="col-md-6">
                <input type="text" class="form-control required" maxlength="5" name="workYear" maxlength="100"  value="${peManager.workYear}"  >
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-3 control-label">从业背景</label>
            <div class="col-md-6">
                <input type="text" class="form-control required" maxlength="6" name="background" maxlength="100"  value="${peManager.background}"  >
            </div>
        </div>
        <div class="form-group">
         ...
         <div class="form-group">
            ...
            <div class="col-md-6">
                <input type="checkbox" name="recommendLocation" value="1" <c:if test="${fn:contains(peManager.recommendLocation,'1')}">checked="checked"</c:if>>平台首页
                <input type="checkbox" name="recommendLocation" value="2" <c:if test="${fn:contains(peManager.recommendLocation,'2')}">checked="checked"</c:if>>版块首页 
                <input type="checkbox" name="recommendLocation" value="0" <c:if test="${fn:contains(peManager.recommendLocation,'0')}">checked="checked"</c:if>>无推荐               
            </div>
        </div>
        <div class="form-group">
...
$(function(){
	...
	$('#myTab a').click(function (e) { 
	      ...
	      if("yes" != isload){	
	    	  var loadUrl = "";
	    	  if("#productOnly" == sel){
	    		  loadUrl = "rest/admin/pe/productOnly/index?managerId=" + ${peManager.id};
	    	  }
