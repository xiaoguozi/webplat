...
<div class="modal-body">
    <form id="modalForm" action="rest/admin/pe/peProduct/insertData" method="post" class="form-horizontal" role="form" data-submit="#modalSaveBtn">
        ...
        <div class="form-group">             
         ...
         <div class="form-group">
            ...
            <div class="col-md-6">
            	 <select name="fundType"  style="width: 200px; height: 30px "  class="form-control required">   
                         ...
                         <option value="8" <c:if test="${peProduct.fundType == '28'}">selected</c:if>>其他</option>    
                </select> 
            </div>
        </div>
         <div class="form-group">
         ...
         <div class="form-group">
            <label class="col-md-3 control-label">认购起点(元)</label>
            <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">       
                <input type="checkbox" name="recommendLocation" value="1" <c:if test="${fn:contains(peProduct.recommendLocation,'1')}">checked="checked"</c:if>>平台首页
                <input type="checkbox" name="recommendLocation" value="2" <c:if test="${fn:contains(peProduct.recommendLocation,'2')}">checked="checked"</c:if>>版块首页 
                <input type="checkbox" name="recommendLocation" value="0" <c:if test="${fn:contains(peProduct.recommendLocation,'0')}">checked="checked"</c:if>>无推荐                                       
            </div>
        </div>
        <div class="form-group">
