...
<div class="modal-body">
    <form id="product_modalForm" action="" method="post" class="form-horizontal" role="form" data-submit="#modalSaveBtn">
...
$(function(){
	...
	Btk.form($("#product_modalForm"),"view");

    $("button.modalCloseBtn").unbind('click').click(function(event) {
        product_IndexPage.togglePage('list');
    });
