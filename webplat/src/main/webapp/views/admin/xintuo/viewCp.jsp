        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-md-3">
                   ...
                   <input type="radio" name="xtcpFb" value="0" <c:if test="${productXtcp.xtcpFb== '2'}">checked="checked"</c:if>>未发布	  
            </div>
            ...
            <div class="col-md-3">
                 ...
                 <input type="radio" name="xtcpInshow" value="0" <c:if test="${productXtcp.xtcpInshow== '2'}">checked="checked"</c:if>>不显示 
            </div>
        </div>
