...
<div class="row">
    <div class="col-md-12">
        ...
        <h3 class="page-title pull-left">用户管理  <small>新增</small></h3>
...
<div class="modal-body">
    <form id="modalForm" action="rest/admin/user/insertData" method="post" class="form-horizontal" role="form" data-submit="#modalSaveBtn">
