            ...
            <table id="list-data" class="table table-striped table-bordered table-hover dataTable no-footer">
                <thead>
                    <tr>
                        ...
                        <th field="username">username <span class="glyphicon"></span></th>
                        <th field="passwordkey">passwordkey <span class="glyphicon"></span></th>
                    </tr>
                </thead>
                <tbody>
                </tbody>
...
$(function(){
    var insertUrl = "rest/admin/user/insert";
    var updateUrl = "rest/admin/user/update";
    var viewUrl = "rest/admin/user/view";
