				...
				<table class="simujingli_box" <c:if test="${fn:length(lstTopPeManager)==(status.index+1)}">style="border-right:solid  1px #d3d3d3"</c:if>>
					...
					<tr>
						...
						<td class="pd_left pd_bottom"><p>
							...
							<p>
								累计收益<br />
								<span class="num_big"><fmt:formatNumber value="${TopPeManager.accumulatedIncome.intValue()}" pattern="#0"/>.</span><span class="small small_color"><fmt:formatNumber value="${xintuofootsmall.xtcpNsyl*100%100}" pattern="00"/>%</span>
							</p></td>
					</tr>
					<tr>
						<td colspan="2">
