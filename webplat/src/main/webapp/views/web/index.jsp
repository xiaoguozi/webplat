...
<div class="tjs_private_textdiv">基金经理：<a href="rest/web/pe/peIndexMDetail?managerId=${smcpData[1].managerId}" target="_blank">${smcpData[1].managerName}</a></div>
<div class="tjs_private_textdiv"> 产品名称：<a href="rest/web/pe/peIndexProductDetail?peProductId=${smcpData[1].id}" target="_blank">${smcpData[1].simpleName}</a></div>
</div>
<div class="tjs_product_textdiv">  ${smcpData[1].managerReview}   </div>
<div class="tjs_right_btndiv"> <a href="rest/web/pe/peIndexProductDetail?peProductId=${smcpData[1].id}" class="tjs_btn" target="_blank">了解详情</a></div>
...
<div class="tjs_private_textdiv">基金经理：<a href="rest/web/pe/peIndexMDetail?managerId=${smcpData[2].managerId}" target="_blank">${smcpData[2].managerName}</a></div>
<div class="tjs_private_textdiv"> 产品名称：<a href="rest/web/pe/peIndexProductDetail?peProductId=${smcpData[2].id}" target="_blank">${smcpData[2].simpleName}</a></div>
</div>
<div class="tjs_product_textdiv">  ${smcpData[2].managerReview}  </div>
<div class="tjs_right_btndiv"> <a href="rest/web/pe/peIndexProductDetail?peProductId=${smcpData[2].id}" class="tjs_btn" target="_blank">了解详情</a></div>
