            ...
            <div class="mycenter_right" id="mycenter_right">
                  ...
                  <div >
	                <form class="modify-form" id="modify-form" action="rest/web/userCenter/saveUserInfo" method="post">
	                 ...
	                 <div class="tjs_register_left" style="width:20%">身份证：</div><div class="tjs_register_right" style="margin-left:20px"><input id="register_certId" name="userInfo.certId" value="${certId}" maxlength="18" type="text" class="tjs_register_input  tjs_width350px" tabindex="1" spellcheck="false" placeholder="" autofocus x-webkit-speech >&nbsp;&nbsp;<span id="cert_id_span" style="color: red;"></span></div>
