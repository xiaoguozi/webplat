    ...
    <div class="container">
        <div class="row">
		    <div class="col-md-12">
			    ...
			    <form class="register-form" action="rest/web/passport/getMPwd2" method="post">
			  ...
			  <div class="form-group">
			    <label>新密码</label>
			    <input type="password" class="form-control" id="register_password" name="password"  placeholder="新密码">
			  </div>
			  <div class="form-group">
			    <label>确认新密码</label>
			    <input type="password" class="form-control" name="rpassword" placeholder="再次输入新密码">
			  </div>
    ...
    var handleRegister = function() {
        ...
        $('.register-form').validate({
            ...
            messages : { 
                userName : {
                    required : "手机号码不能为空.",
                    remote:"手机号未注册过，您可以直接<a href='rest/web/passport/mreg'>注册</a>"
                },
                password : {
                    required : "密码不能为空."
                },
