...
<body>
	<div class="home_all">
        ...
        <div class="mod_breadcrumb">
            <div class="layout_n clearfix"><span class="home">当前位置 ：</span> <a href="" class="path_item">首页</a> <span class="sep">&gt;</span> <a href="rest/web/peizi/index" class="path_item">配资</a> <span class="sep">&gt;</span> <a href="rest/web/peizi/self" class="path_item">淘金自营</a> <span class="sep">&gt;</span> <span class="txt">产品明细</span> </div>
        </div>
    <div class="w100bg">
