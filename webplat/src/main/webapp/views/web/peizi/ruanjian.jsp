	...
	<div class="home_all">
       <%@ include file="/views/web/header.jsp"%>
        ...
        <div class="mod_breadcrumb">
            <div class="layout_n clearfix"><span class="home">当前位置 ：</span> <a href="" class="path_item">首页</a> <span class="sep">&gt;</span> <a href="rest/web/peizi/index" class="path_item">配资</a> <span class="sep">&gt;</span> <span class="txt">交易软件下载</span> </div>
        </div>
    <div class="w100bg">
