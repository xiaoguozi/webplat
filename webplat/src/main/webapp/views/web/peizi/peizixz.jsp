<%@page contentType= "text/html;charset=UTF-8" %>
         ...
         <div class="bgcolor">
             ...
             <div class="peizhibox">
                 ...
                 <p>1、全程只需向淘金山每月支付利息，无其他任何费用。市场风险莫测，务请谨慎行事！</p>
                 <p>2、您的投资本金：您交付的保证金，最少2千，最多500万，必须是1000元的倍数；</p>
                 <p>3、资金使用期限：按月计算，如使用1个月，1月8日到2月7日，当月日期没有的按当月日期的最后一天计算，日期为自然日，即包含各类节假日；</p>
                 <p>4、每月利息支付：每月支付利息，如1月8日配资，1月8日支付第1个月利息，2月7日前支付第2个月利息，以此类推；</p>
                 <p>5、亏损警告线：当总操盘资金低于警戒线以下时，只能减仓不能建仓，我们将有权把您的股票最多减仓到操盘资金的40%；</p>
