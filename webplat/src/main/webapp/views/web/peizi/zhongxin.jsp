...
<body>
	...
	<%@ include file="/views/web/header.jsp"%>
        ...
        <div class="mod_breadcrumb">
            <div class="layout_n clearfix"><span class="home">当前位置 ：</span> <a href="http://www.taojinshan.com.cn" class="path_item">首页</a> <span class="sep">&gt;</span> <a href="index.html" class="path_item">配资</a> <span class="sep">&gt;</span> <span class="txt">个人中心</span> </div>
        </div>
    <div class="w100bg">
        <hr class="pc"/>
        <div class="tjs_1108px center">
            ...
            <div class="mycenter_right">
                ...
                <b class="my_tit tit1">天天配 <span class="tit_span">进行中<span class="colorf06">1</span>笔</span><span class="f-right">交易账号密码请在方案详情中查看&nbsp;&nbsp;</span></b>
                <!--有产品状态 无产品隐藏-->
                <table class="my_tbl2">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><a class="tjs_next_btn" href="rest/web/peizi/centerDaySchedule">查询方案详情</a></td>
                    </tr>
                </table>
                <!--无产品状态-->
                <table class="my_tbl2">
                    <tr>
                        <td colspan="5"><a class="my_add" href="rest/web/peizi/dayCapital" title="添加配资"></a></td>
                    </tr>
                </table>
                <!--/无产品状态-->
            </div>
