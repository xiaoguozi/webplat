	...
	<div class="home_all">
       <%@ include file="/views/web/header.jsp"%>
        ...
        <div class="mod_breadcrumb">
            <div class="layout_n clearfix"><span class="home">当前位置 ：</span> <a href="http://www.taojinshan.com.cn" class="path_item">首页</a> <span class="sep">&gt;</span> <a href="index.html" class="path_item">配资</a> <span class="sep">&gt;</span> <span class="txt">淘金活动</span> </div>
        </div>
    <div class="w100bg">
