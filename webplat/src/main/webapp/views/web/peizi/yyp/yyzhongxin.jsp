    ...
    <div class="w100bg">
        ...
        <div class="tjs_1108px center">
            ...
            <div class="mycenter_right">
                ...
                <b class="my_tit tit1">月月配 <span class="tit_span">进行中<span class="colorf06">1</span>笔</span><span class="f-right">交易账号密码请在方案详情中查看&nbsp;&nbsp;</span></b>
                <!--有产品状态 无产品隐藏-->
                <table class="my_tbl2">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><a class="tjs_next_btn" href="rest/web/peizi/monthScheduleCapital">查询方案详情</a></td>
                    </tr>
                </table>
                <!--无产品状态-->
                <table class="my_tbl2">
                    <tr>
                        <td colspan="5"><a class="my_add" href="rest/web/peizi/monthCapital" title="添加配资"></a></td>
                    </tr>
                </table>
                <!--/无产品状态-->
            </div>
