...
<body>
    <div class="home_all">
                ...
                <div class="top_wrap_menu menu">
                    <ul>
                        ...
                        <li><span>淘金自营</span></li>
                         -->
                        <li><a href="rest/web/peizi/usercenter/yypUserCenter"><span>个人中心</span></a></li>
        ...
        <div class="mod_breadcrumb">
            <div class="layout_n clearfix"><span class="home">当前位置 ：</span> <a href="" class="path_item">首页</a> <span class="sep">&gt;</span> <a href="rest/web/peizi/index" class="path_item">配资 </a><span class="sep">&gt;</span> <a href="rest/web/peizi/capital" class="path_item">淘金配资</a> <span class="sep">&gt;</span> <span class="txt">月月配</span> </div>
        </div>
        <div class="w100bg">
         <input type="hidden" name="dataId" value="${peizi.dataId}"/>
            <div class="tjs_1108px center">
                ...
                <div class="bgcolor">
                    ...
                    <div class="datastep3" style="padding-top:2px;padding-bottom:50px">                      
