        ...
        <div class="tjs_1108px center">
            <div class="bgcolor">
	            ...
	            <div class="mycenter_right" id="mycenter_right">
	                  <div id="div_mfp">
	                  			<form name="payForm" class="hform" id="payForm" action="rest/web/peizi/yyp/confirmPay" target="_blank" method="post">
				                ...
				                <table class="my_tbl2"  >
				                    <tr>
				                    	<c:if test="${peizi.dataOperaStatus=='1'}">
					                    	<td rowspan="2" ><a class="tjs_next_btn" id="aPay" dataId="${peizi.dataId}" href="" style="width: 110px;">前往支付</a></td>
				                        </c:if>
