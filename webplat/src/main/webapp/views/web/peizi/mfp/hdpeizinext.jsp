                    ...
                    <div class="peizidata_box">
                        ...
                        <table class="pz_tbl">
                            <tr>
                                ...
                                <td>亏损平仓线 <img class="curser" src="assets/img/peizi/qcmark.png" title="当总操盘资金低于平仓线以下时，我们将有权把您的股票进行平仓，为避免平仓发生，请时刻关注投资本金是否充足。" alt="" />：<span class="colorf06 font26"><fmt:formatNumber value="${pcx}" pattern="########.##" /></span> 元</td>
                            </tr>
                            <tr>
                                <td>亏损警告线 <img class="curser" src="assets/img/peizi/qcmark.png" title="当总操盘资金低于亏损警戒线以下时，只能平仓不能建仓，需要尽快补充投资本金，以免低于亏损平仓线被平仓" alt="" />：<span class="colorf06 font26"><fmt:formatNumber value="${jjx}" pattern="########.##" /></span> 元</td>
                    ...
                    <div class="zhifu_box">
                        <table class="zhifu_boxtbl">
                            ...
                            <tr>
                                ...
                                <td class="colorf06 font26 t-right">1 元</td>
                            </tr>
                        </table>
                        <a class="tjs_btndiv btnbox" href="rest/web/peizi/index">重选操盘方案</a>
                    </div>
