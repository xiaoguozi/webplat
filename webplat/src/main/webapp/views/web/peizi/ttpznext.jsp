...
<body>
	<div class="home_all">
        ...
        <div class="mod_breadcrumb">
            <div class="layout_n clearfix"><span class="home">当前位置 ：</span> <a href="http://www.taojinshan.com.cn" class="path_item">首页</a> <span class="sep">&gt;</span> <a href="index.html" class="path_item">配资 </a><span class="sep">&gt;</span> <a href="tjpeizi.html" class="path_item">淘金配资</a> <span class="sep">&gt;</span> <span class="txt">天天配</span> </div>
        </div>
    <div class="w100bg">
            ...
            <div class="bgcolor">
                    ...
                    <div class="peizidata_box">
                        ...
                        <table class="pz_tbl">
                            ...
                            <tr>
                                ...
                                <td>资金使用期限 <img class="curser" src="assets/img/peizi/qcmark.png" title="按交易日计算，节假日不收管理费" alt="" />：2 天</td>
                            </tr>
                            <tr>
                                <td>账户管理费 <img class="curser" src="assets/img/peizi/qcmark.png" title="每天需要支付的管理费" alt="" />：<span class="colorf06 font26">7.5</span> 元/天</td>
                                <td>开始交易时间 <img class="curser" src="assets/img/peizi/qcmark.png" title="一般选择下个交易日，如看中行情急需交易，可直接选择今天开始。14:40以后只能选择下个交易日" alt="" />：下个交易日</td>
                            </tr>
                        </table>
                    </div>
                </div>
                <div class="caopanjine1">
                    ...
                    <div class="zhifu_box">
                        ...
                        <a class="tjs_btndiv btnbox" href="ttpeizi.html">重选操盘方案</a>
                    </div>
                    <a class="tjs_next_btn mbl" href="rest/web/peizi/dayLastCapital">确定配资</a>
                    <p class="t-right ptr">您的账户余额：<span class="colorf06">0.00</span>，本次支付还差<span class="colorf06">2522.5</span>元，请先<a href="chongzhi.html">充值</a></p>
                </div>
                <hr class="pc"/>
            </div>
            <div class="pz_produce">
