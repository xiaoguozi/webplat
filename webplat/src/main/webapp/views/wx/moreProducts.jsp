...
<body>
    <div class="container">
		...
		<div class="row" style="border-bottom:1px solid #E0E0E0;">
			<div class="col-xs-2" style="padding-top: 15px;"><img src="assets/img/wx/baoxian.png" /></div>
			<div class="col-xs-8">
				<p style="font-size:20px; color:#000; margin-top: 12px;"><b>海外保险<b></p>
