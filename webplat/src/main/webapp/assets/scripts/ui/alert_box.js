	  ...
	  $.post(IndexPage.orderProductUrl, 
        ...
        function(data){		  
    	 ...
    	 var html="<div class='capacity' style='font-size:20px'>温馨提示</div><div class='tip_in_box' style='text-align: center;float:left'>";
	  	    html+="<div style='width:200px;height:160px;border-right:1px solid #afafaf;float:left'><img src='assets/img/ui2/aboutimg2.png'/ style='width:160px;height:160px'><p style='font-size:14px;margin-left:0px'>扫一扫,获取最新预约动态</P></div>"
