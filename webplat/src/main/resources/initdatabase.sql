...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`tjs` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `user`(`id`,`username`,`password`,`state`,`create_time`) values (1,'hello','8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92',NULL,'2014-07-17 12:59:08');
